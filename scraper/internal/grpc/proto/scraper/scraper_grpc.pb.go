...
type ScraperClient interface {
	Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*TaskResponse, error)
}
...
func (c *scraperClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*TaskResponse, error) {
	out := new(TaskResponse)
	err := c.cc.Invoke(ctx, "/scraper.Scraper/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ScraperServer interface {
	Login(context.Context, *LoginRequest) (*TaskResponse, error)
...
func (UnimplementedScraperServer) Login(context.Context, *LoginRequest) (*TaskResponse, error) {
...
func _Scraper_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ScraperServer).Login(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/scraper.Scraper/Login",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ScraperServer).Login(ctx, req.(*LoginRequest))
	}
...
var Scraper_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Login",
			Handler:    _Scraper_Login_Handler,
		},
	},
